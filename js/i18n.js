...
const TESTI = {
  ...
  it: {
    ...
    "dida.deriva":    "una modulazione ogni {t}",
    ...
    "banco.formato":      "{khz} kHz · 24 bit",
    "banco.tetto":        "max {t}",
    "banco.presaNegata":  "non riesco ad aprire la presa",
    "banco.salvato":      "{s} s salvati",
    "banco.salvatiN":     "{n} file · {s} s",
    "banco.nulla":        "non è arrivato niente",
    ...
    "pae.micSessione":    "sessione audio non pronta",
    ...
    "a11y.cambiaTonalita": "Cambia tonalità: una quinta in senso orario",
    "a11y.soglia":      "Soglia del limitatore",
    "a11y.rilascio":    "Rilascio del limitatore",
    "a11y.tracce":      "Che cosa registrare",
    ...
    tracce:  { mix: "mix", sorgenti: "sorgenti", stanza: "sorgenti + stanza", tutto: "tutto" },
  ...
  fr: {
    ...
    "dida.deriva":    "une modulation toutes les {t}",
    ...
    "et.mixer":         "MIXAGE",
    "et.tracce":        "PISTES",
    "et.limitatore":    "LIMITEUR",
    "mix.on":           "ON",
    "a11y.accensione":  "Allumage de {canale}",
    "et.sorgente":      "SOURCE",
    "et.tonalita":      "TONALITÉ",
    "et.cambiaTonalita": "CHANGER DE TONALITÉ",
    ...
    "banco.formato":      "{khz} kHz · 24 bits",
    "banco.tetto":        "max {t}",
    "banco.presaNegata":  `impossible d'ouvrir la prise`,
    "banco.salvato":      "{s} s enregistrés",
    "banco.salvatiN":     "{n} fichiers · {s} s",
    "banco.nulla":        "rien n'est arrivé",
    ...
    "pae.micSessione":    "session audio pas prête",
    ...
    "a11y.cambiaTonalita": "Changer de tonalité : une quinte dans le sens horaire",
    "a11y.soglia":      "Seuil du limiteur",
    "a11y.rilascio":    "Relâchement du limiteur",
    "a11y.tracce":      "Ce qu'il faut enregistrer",
    ...
    tracce:  { mix: "mix", sorgenti: "sources", stanza: "sources + salle", tutto: "tout" },
  ...
  en: {
    ...
    "dida.deriva":    "one modulation every {t}",
    ...
    "et.mixer":         "MIXER",
    "et.tracce":        "TRACKS",
    "et.limitatore":    "LIMITER",
    "mix.on":           "ON",
    "a11y.accensione":  "{canale} on",
    "et.sorgente":      "SOURCE",
    "et.tonalita":      "KEY",
    "et.cambiaTonalita": "CHANGE KEY",
    ...
    "banco.salvato":      "{s} s saved",
    "banco.salvatiN":     "{n} files · {s} s",
    "banco.nulla":        "nothing came through",
    "banco.minuti":       "{n} minutes",
    "banco.piatto":       "flat",
    ...
    "pae.micSessione":    "audio session not ready",
    ...
    "a11y.cambiaTonalita": "Change key: one fifth clockwise",
    "a11y.soglia":      "Limiter threshold",
    "a11y.rilascio":    "Limiter release",
    "a11y.tracce":      "What to record",
    ...
    tracce:  { mix: "mix", sorgenti: "sources", stanza: "sources + room", tutto: "everything" },
  ...
  ja: {
    ...
    "banco.salvato":      "{s}秒を保存",
    "banco.salvatiN":     "{n}ファイル・{s}秒",
    "banco.nulla":        "何も届きませんでした",
    "banco.minuti":       "{n}分",
    "banco.piatto":       "平坦",
    "banco.profiloN":     "設定{n}",
    ...
    "a11y.cambiaTonalita": "調を変える：時計回りに五度",
    "a11y.soglia":      "リミッターの閾値",
    "a11y.rilascio":    "リミッターのリリース",
    "a11y.tracce":      "何を録音するか",
    "a11y.fine":        "区間の終わり",
    ...
    tracce:  { mix: "ミックス", sorgenti: "音源", stanza: "音源＋残響", tutto: "すべて" },
...
const nomeTracce  = (id) => (TESTI[lingua].tracce || {})[id] || id;
