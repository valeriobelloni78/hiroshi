...
const TESTI = {
  ...
  it: {
    ...
    "sez.deriva":     "Deriva",
    "dida.frasi":     "quattro frasi",
    "dida.tenute":    "quattro tenute",
    "dida.banco":     "l'uscita dello studio · registrazione, equalizzatore, mixer",
    "dida.paesaggio": "una registrazione tenuta ferma sotto una lente",
  ...
  fr: {
    ...
    "sez.deriva":     "Dérive",
    "dida.frasi":     "quatre phrases",
    "dida.tenute":    "quatre tenues",
    "dida.banco":     "la sortie du studio · enregistrement, égaliseur, mixage",
    "dida.paesaggio": "un enregistrement tenu immobile sous une loupe",
  ...
  en: {
    ...
    "sez.deriva":     "Drift",
    "dida.frasi":     "four phrases",
    "dida.tenute":    "four sustains",
    "dida.banco":     "the studio output · recording, equaliser, mixer",
    "dida.paesaggio": "a recording held still under a lens",
  ...
  ja: {
    ...
    "dida.frasi":     "四つのフレーズ",
    "dida.tenute":    "四つの持続",
    "dida.banco":     "工房の出口 · 録音、等化器、混合",
    "dida.paesaggio": "レンズの下に留めた録音",
